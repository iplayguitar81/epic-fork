...
Route::get('/recipes/', ['as' => 'posts.recipes', 'uses'=>'PostsController@recipes']);

Route::get('/recipes/appetizers-and-beverages', ['as' => 'posts.appetizers-and-beverages', 'uses'=>'PostsController@appetizers_beverages']);
Route::get('/recipes/casseroles', ['as' => 'posts.casseroles', 'uses'=>'PostsController@casseroles']);
Route::get('/recipes/desserts-and-baked-goods', ['as' => 'posts.desserts-and-baked-goods', 'uses'=>'PostsController@desserts_baked_goods']);
Route::get('/recipes/fish-and-poultry', ['as' => 'posts.fish-and-poultry', 'uses'=>'PostsController@fish_poultry']);
Route::get('/recipes/meat', ['as' => 'posts.meat', 'uses'=>'PostsController@meat']);
Route::get('/recipes/misc-canning-etc', ['as' => 'posts.misc-canning-etc', 'uses'=>'PostsController@misc_canning']);
Route::get('/recipes/pasta', ['as' => 'posts.pasta', 'uses'=>'PostsController@pasta']);
Route::get('/recipes/soups-and-salads', ['as' => 'posts.soups-and-salads', 'uses'=>'PostsController@soups_salads']);
Route::get('/recipes/vegetables', ['as' => 'posts.vegetables', 'uses'=>'PostsController@vegetables']);
