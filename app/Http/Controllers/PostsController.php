...
//        $caption = $request->input('caption');
    ...
    public function user_posts() {
       ...
       # return view('user_posts', compact('posts'));
        return \View::make('posts.user_posts', compact('posts', 'user_name', 'user'));
    }
...
//        $posts = Post::select('user_id', 'title', 'subhead','body','imgpath', 'created_at')->get();
    ...
    public function recipes()
    {
        ...
        $appetizers_beverages = Post::where('category', '=', $category)->take(3)->orderBy('created_at', 'desc')->get();


        $category1="casseroles";

        $casseroles = Post::where('category', '=', $category1)->take(3)->orderBy('created_at', 'desc')->get();

        $category2="desserts-and-baked-goods";

        $desserts_baked_goods = Post::where('category', '=', $category2)->take(3)->orderBy('created_at', 'desc')->get();


        $category3="fish-and-poultry";

        $fish_poultry = Post::where('category', '=', $category3)->take(3)->orderBy('created_at', 'desc')->get();


        $category4="meat";

        $meat = Post::where('category', '=', $category4)->take(3)->orderBy('created_at', 'desc')->get();


        $category5="misc-canning-etc";

        $misc_canning = Post::where('category', '=', $category5)->take(3)->orderBy('created_at', 'desc')->get();


        $category6="pasta";

        $pasta = Post::where('category', '=', $category6)->take(3)->orderBy('created_at', 'desc')->get();

        //soups-and-salads
        $category7="soups-and-salads";

        $soups_salads = Post::where('category', '=', $category7)->take(3)->orderBy('created_at', 'desc')->get();


        //vegetables

        $category8="vegetables";

        $vegetables = Post::where('category', '=', $category8)->take(3)->orderBy('created_at', 'desc')->get();

        return view('posts.recipes', compact('appetizers_beverages','casseroles', 'desserts_baked_goods', 'fish_poultry', 'meat', 'misc_canning', 'pasta', 'soups_salads', 'vegetables'));
    }

    public function appetizers_beverages()
    {
        ...
        return view('posts.appetizers-and-beverages', compact('news'));
    }


    public function casseroles()
    {
        ...
        return view('posts.casseroles', compact('news'));
    }



    public function desserts_baked_goods()
    {

        $category="desserts-and-baked-goods";
        $news = Post::where('category', '=', $category)->orderBy('created_at', 'desc')->get();
        $news =collect($news);

        return view('posts.desserts-and-baked-goods', compact('news'));
    }


    public function fish_poultry()
{

    $category="fish-and-poultry";
    $news = Post::where('category', '=', $category)->orderBy('created_at', 'desc')->get();
    $news =collect($news);

    return view('posts.fish-and-poultry', compact('news'));
}
    ...
    public function meat()
    {
        ...
        return view('posts.meat', compact('news'));
    }

    //misc-canning-etc


    public function misc_canning()
    {

        $category="misc-canning-etc";
        $news = Post::where('category', '=', $category)->orderBy('created_at', 'desc')->get();
        $news =collect($news);

        return view('posts.misc-canning-etc', compact('news'));
    }
    ...
    public function pasta()
    {
        ...
        return view('posts.pasta', compact('news'));
    }


    public function soups_salads()
{
    ...
    return view('posts.soups-and-salads', compact('news'));
}
    ...
    public function vegetables()
    {
        ...
        return view('posts.vegetables', compact('news'));
    }
