    ...
    <br/>
        ...
        <div class="form-group {{ $errors->has('subHead') ? 'has-error' : ''}}">
            ...
            <div class="form-group">
               ...
               'appetizers-and-beverages' => 'Appetizers & Beverages',
               'casseroles' => 'Casseroles',
               'desserts-and-baked-goods' => 'Desserts & Baked Goods',
               'fish-and-poultry' => 'Fish & Poultry',
               'meat' => 'Meat',
               'misc-canning-etc' => 'Misc. Canning etc.',
               'pasta' => 'Pasta',
...
<br/>
    ...
    <a href="{{url('posts')}}">
        ...
        <button type="submit" class="btn btn-primary btn-md active">Back to All Posts</button>
    </a>
